...
export const createConnectionRequestEmailTemplate = (recipientName, senderName, senderHeadline, profileUrl) => `
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <div style="background-color: #ffffff; padding: 30px; border-radius: 0 0 10px 10px; box-shadow: 0 4px 10px rgba(0,0,0,0.1);">
    ...
    ${senderHeadline ? `
    <div style="background-color: #f3f6f8; padding: 15px; border-radius: 8px; margin: 20px 0;">
      <p style="color: #555; margin: 0; font-style: italic;">"${senderHeadline}"</p>
    </div>` : ""}
    <div style="text-align: center; margin: 30px 0;">
      <a href="${profileUrl}" style="background-color: #0077B5; color: white; padding: 14px 28px; text-decoration: none; border-radius: 30px; font-weight: bold; font-size: 16px; transition: background-color 0.3s;">View Invitation</a>
    </div>
    <p>Expand your network and see what ${senderName} and other connections are sharing.</p>
    <p>Best regards,<br>The Linkedin Team</p>
  </div>
</body>
</html>
